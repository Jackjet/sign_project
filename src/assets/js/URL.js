const URL = {
    ...
    /*后台管理系统*/
    authCompayVerify:'sys/authCompayVerify/searchPaging',                          //实名认证列表
    verifyView:'sys/authCompayVerify/view',                                        //审核详情
    downloadAuthImg:'sys/authCompayVerify/downloadAuthImg',                        //获取审核图片
    verifyCheck:'sys/authCompayVerify/verify',
