  ...
  <div class="index_welcome">
      <div class="container-fluid top-nav" id="fixedBar">
          <div class="container header row">
              <span class="col-lg-3" v-if="!cloudyState"><img class="logo" src="../../assets/images/welcome/logo.png"></span>
              <span class="col-lg-3" v-if="cloudyState"><img class="logo" src="../../assets/images/welcome/logo_c.png"></span>
              <div class="col-lg-9 nav-btn">
                ...
                <router-link v-show="userName && userState != 0" to="/cus/account/accountIndex" class="register">个人中心</router-link>
                <a v-show="userName && userState==0" href="/sys/largeCompany/toLargeCompanyPage" class="register" target="_blank">个人中心</a>
                <a v-show="!userName && !cloudyState" href="/logout" class="login" target="_blank">登录</a>
                <a v-show="!userName && cloudyState" href="https://fssc.bigfintax.com" class="login" target="_blank">登录</a>
                <a v-show="!userName && !cloudyState" href="/register" class="register" target="_blank" >注册</a>
              </div>                      
          </div>
      </div>
      <div class="fiexd-right" :class="[cloudyState ? 'marginTopZero':'']">
        <div class="fixed-icon" @click="toTop"><i class="icon-up-open-big"></i></div>
        <div class="fixed-icon service" v-if="!cloudyState">
        ...
        <div class="fixed-icon share" v-if="!cloudyState">
        ...
        <div class="fixed-icon ewm-box" v-if="!cloudyState">
          <i class="icon-ewm"></i>
          <div class="hover-box">
      ...
      <footer> 
        <p>
          <a href="https://www.gdca.com.cn/about_gdca/other/contact/" target="_blank" v-if="!cloudyState">联系我们</a>
        ...
        <p class="copy">{{cloudyState ? '京ICP备17048858号-2 Copyright © 2017神州云合 版权所有':'Copyright © 2015 数安时代科技股份有限公司 广东信鉴信息科技有限公司 All Rights Reserved. 粤ICP备05036352号'}}</p>
      </footer>
  </div>
</template>
